...
const instagramPosts: InstagramPost[] = [
  {
    ...
    description: "Dicas essenciais para ganho de massa muscular",
  ...
  },
  {
    ...
    description: "Como executar exercícios com perfeição",
    embedUrl: "https://www.instagram.com/reel/DK1_ghhx8os/",
    postId: "DK1_ghhx8os"
  }
];
...
const InstagramPostCard = ({ post }: { post: InstagramPost }) => {
  useEffect(() => {
    // Trigger Instagram embed script to process the new content
          ...
          {slidesToShow < instagramPosts.length && (
            <>
              <Button
                ...
                variant="outline"
                size="icon"
                className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm shadow-lg hover:bg-white disabled:opacity-50 w-12 h-12 -ml-6 hidden md:flex"
              >
              ...
              <Button
                ...
                variant="outline"
                size="icon"
                className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 backdrop-blur-sm shadow-lg hover:bg-white disabled:opacity-50 w-12 h-12 -mr-6 hidden md:flex"
              >
