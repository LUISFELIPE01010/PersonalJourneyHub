...
const InstagramVideoCard = ({ video }: { video: InstagramVideo }) => (
  <div className="relative group cursor-pointer">
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 p-0.5">
      <div className="relative bg-white rounded-2xl overflow-hidden">
        <div className="aspect-[9/16] relative overflow-hidden">
          ...
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-pink-500 via-red-500 to-yellow-500 opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
        </div>
